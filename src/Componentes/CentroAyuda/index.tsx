    ...
    <div className="CentroAyuda-contenedor">
      ...
      <div className="CentroAyuda-opciones">
        ...
        <div className="CentroAyuda-faq">
          ...
          <ul>
            <li><strong>¿Cómo cancelo mi reserva?</strong> Puedes cancelarla en la sección "Cuenta"-"Mis Reservas", siempre que no infrinja las políticas establecidas antes de realizar la reserva</li>
            ...
            <li><strong>¿Cómo contacto al anfitrión?</strong> En la página de cada Glamping tienes un botón para enviarle un mensaje.</li>
          </ul>
        </div>
      </div>
    </div>
