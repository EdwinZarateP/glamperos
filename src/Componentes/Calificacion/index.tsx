...
const Calificacion: React.FC<CalificacionProps> = ({ calificacionNumero }) => {
  const getEstrellas = () => {
  ...
  return (
    <div className="calificacion-contenedor">
      ...
      <div className="calificacion-texto">
        <GiLaurelCrown className="calificacion-icono-corazon" />
        <span>{getTextoCalificacion()}</span>
      </div>
      <div className="calificacion-evaluaciones">
        <span className="calificacion-numero-evaluaciones">8</span>
