...
const SepararFechas: React.FC = ({}) => {
  ...
  // Función para enviar las fechas a la API
  const enviarFechasAPI = async () => {
    try {
      ...
      // Enviar las fechas al endpoint de la API
  ...
  return (
    <>
      <div className="SepararFechas-contenedor">
        <p> Haz clic en este botón para bloquear fechas y evitar que estén
           disponibles para reservas. Ten en cuenta que la fecha 'Hasta' 
           no se incluye en el rango seleccionado.</p>
        <div
